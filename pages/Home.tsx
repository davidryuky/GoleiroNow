    ...
    <div className="bg-dark text-white">
      ...
      <div className="relative h-[70vh] min-h-[500px] flex items-center justify-center text-center px-4 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="bg-black/20 backdrop-blur-md p-4 md:p-6 rounded-lg max-w-4xl mx-auto animate-fade-in border border-white/10">
              <form className="grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
                  <input type="text" placeholder="Cidade" className="bg-gray-800/50 border border-gray-700 text-white rounded-lg px-4 py-3 focus:ring-2 focus:ring-primary focus:border-primary transition-colors duration-200 col-span-1 md:col-span-3" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 className="text-3xl lg:text-4xl font-bold text-center mb-2 font-orbitron">Goleiros em Destaque</h2>
